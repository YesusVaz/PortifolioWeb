        ...
        <div className="relative">
          ...
          <div className="space-y-8 sm:space-y-10">
            {EXPERIENCES.map((experience, index) => (
              ...
              >
                <div
                  className={`absolute left-0 sm:left-2 top-1 size-8 rounded-full flex items-center justify-center ${
                    experience.current
                ...
                <div className="bg-white dark:bg-background-dark rounded-xl sm:rounded-2xl border border-gray-200 dark:border-gray-700/50 p-4 sm:p-6">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 sm:gap-4 mb-2">
                    <h3 className="text-foreground dark:text-white text-lg sm:text-xl font-semibold">
                      {getLocalized(language, experience.roleEn, experience.roleEs, experience.rolePt)}
                    </h3>
                    <span
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                    {getLocalized(language, experience.descriptionEn, experience.descriptionEs, experience.descriptionPt)}
                  </p>
                </div>
              </motion.div>
            ))}
